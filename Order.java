...
/**
 * Object that stores input information from user and further calculations and gives access from several files
 */
public class Order {
...
/*
    ...
    public HashMap reducePsus() throws Exception{

   //     Preprocessing access = new Preprocessing();

        HashMap<Integer,String> itemsInMap = this.warehouseReader();
        ArrayList<Integer> orderlist = this.gettingTheOrder();
        HashMap<Integer,ArrayList<Integer>> psus = this.gettingPSUs();
