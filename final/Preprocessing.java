...
public class Preprocessing {
    ...
    public static void prepare(Order o) throws IOException, Exception {
        ...
        switch (selectedAlg){
             case "Hill-Climbing": solution =  NewHillClimbing.hillClimbing(o);               
                break; 
            case "First-Choice Hill-Climbing": solution = NewHillClimbing.hillClimbing(o);
                break;
            case "Random-Restart Hill-Climbing":  solution = RandomRestart.randomRestart(o);
                break; 
            case "Simulated Annealing": solution = SimulatedAnnealing.simulatedAnnealing(o);
                break;
            case "Local-Beam Search": solution = LocalBeam.localBeamSearch(o);
                break;  
        } 
